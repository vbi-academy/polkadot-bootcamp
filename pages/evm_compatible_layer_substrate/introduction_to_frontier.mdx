...
#### Self Contained của Frontier là gì? 



#### Thêm Ethereum runtime API ( ETH compatible RPC methods)
...
#### Implement TransactionConverter
...
#### Thêm convert transaction ETH  sang Substrate Runtime API 
...
#### Định nghĩa Eth RPC and mapping sync worker ở node 
<details>
  <summary>Code</summary>
```rust
